...
<template>
    <div class="flex justify-between mb-6 flex-col md:flex-row md:items-center gap-4">
        ...
        <div class="flex items-center gap-4">
            <button
                class="giopic-icon-btn w-10 h-10 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-primary/50 hover:text-primary transition-all shadow-sm hover:shadow-md"
                @click="router.back()">
